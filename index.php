...
/**
 * ARQUIVO: index.php
 * VERSÃO: 4.4 - Layout V4.2 Restaurado + Perfil Compacto Mobile
 * DESCRIÇÃO: Mantém o design clean e alinhamento stretch (V4.2), 
 * mas otimiza o card de perfil para mobile conforme solicitado.
 */
    ...
    <main class="w-full max-w-5xl relative z-10 flex flex-col items-center">
            ...
            <div class="w-full bg-white rounded-[2rem] shadow-clean p-10 relative overflow-hidden anim-fade-in-up delay-200 hover:shadow-clean-lg transition-shadow duration-500">
                ...
                <form id="form-check-cpf" class="space-y-6">
                    ...
                    <div class="text-center pt-2">
                         <p class="text-xs text-slate-400 cursor-pointer hover:text-tks-primary transition font-medium hover:underline decoration-tks-primary/30 underline-offset-4" onclick="fillTestCpf()">
                            Usar CPF de teste
                        </p>
                    </div>
                </form>
        ...
        <div id="screen-dashboard" class="w-full hidden flex-col items-center">
            ...
            <div class="w-full grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-8">
                ...
                <!-- COLUNA 1: PERFIL (Compacto Mobile / Full Desktop) -->
                <div class="lg:col-span-1 anim-fade-in-up delay-100 flex flex-col">
                    <!-- AQUI ESTÁ A LÓGICA DO CARD COMPACTO -->
                    <div class="bg-white rounded-[1.5rem] lg:rounded-[2rem] shadow-clean p-5 lg:p-8 text-left lg:text-center hover:shadow-clean-lg transition-shadow duration-300 h-full flex flex-col justify-between">
                        ...
                        <div class="flex flex-col gap-1 lg:block">
                            ...
                            <!-- Avatar (Oculto no Mobile 'hidden', Visível no Desktop 'lg:flex') -->
                            ...
                            <!-- Nome + Status (Flex Row no Mobile, Block no Desktop) -->
                            ...
                            <!-- Empresa (Mesma linha no Mobile, Linha nova no Desktop) -->
                        ...
                        <!-- Botão Sair (Mais compacto no Mobile) -->
                ...
                <!-- COLUNA 2: BENEFÍCIOS (Mantido Idêntico ao V4.2) -->
                <div class="lg:col-span-2 flex flex-col gap-4 lg:gap-6">
                    ...
                    <!-- CARD 1: CLUBE -->
                    <!-- Adicionei ID 'card-clube' para controle futuro se necessário -->
                    <div id="card-clube" class="btn-card-press anim-fade-in-up delay-200 benefit-card bg-white rounded-[1.5rem] p-5 lg:p-6 shadow-clean border border-transparent hover:border-tks-primary/20 transition-all duration-300 relative overflow-hidden group cursor-pointer" onclick="triggerCardAction('clube')">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 lg:gap-6 items-start relative z-10">
                            ...
                            <div class="flex-grow w-full">
                                ...
                                <div id="status-clube-area">
                                    <button class="action-btn w-full sm:w-auto px-6 py-2.5 lg:py-3 bg-slate-800 text-white text-xs lg:text-sm font-bold rounded-xl hover:bg-tks-primary transition-all shadow-md flex items-center justify-center gap-2 group-hover:translate-x-1 group-hover:shadow-lg">
                                        Ativar Benefício <i class="fas fa-arrow-right text-[10px] lg:text-xs group-hover:translate-x-1 transition-transform"></i>
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- CARD 2: TELEMEDICINA -->
                    <div id="card-tele" class="btn-card-press anim-fade-in-up delay-300 benefit-card bg-white rounded-[1.5rem] p-5 lg:p-6 shadow-clean border border-transparent hover:border-tks-primary/20 transition-all duration-300 relative overflow-hidden group cursor-pointer" onclick="triggerCardAction('tele')">
                            ...
                            <div class="flex-grow w-full">
                                ...
                                <div id="status-tele-area">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <a href="#" class="text-xs lg:text-sm font-semibold text-slate-400 hover:text-tks-primary transition border-b-2 border-transparent hover:border-tks-primary pb-0.5 group-hover:text-tks-primary/70">
                                            Acessar Plataforma
                                        </a>
                                    </div>
                                </div>
